10 REM
20 OL = -16296
30 DIM D(20): DIM M(20)
40 C = 0: A = 0: PS = 0: PC = 0
50 GOSUB 550
60 HOME
70 PRINT "UPRAVLENIE NA ROBOT."
80 PRINT
90 PRINT "1. KAJI KAKVO DA PRAVYA"
100 PRINT "2. START"
110 PRINT "3. IZTRIVANE NA PAMETTA"
120 PRINT
130 PRINT "VAVEDETE CHISLO"
140 INPUT C
150 IF C < 1 OR C > 3 THEN GOTO 130
160 ON C GOSUB 180,440,550
170 GOTO 60
180 PC = PS
190 HOME
200 IF PC = 20 THEN GOTO 390
210 PRINT
220 PRINT "ZADAJTE STYPKA NOMER: "; PC
230 PRINT "POSOKA, POSLE VREME."
240 INPUT M$(PC)
250 IF M$(PC)="S" THEN GOTO 410
260 INPUT D(PC)
270 P1 = 999
280 GOSUB 580
290 IF P1 <> 999 AND D(PC) > 0 THEN GOTO 320
300 PRINT "GRESHNA KOMANDA"
310 GOTO 220
320 GOSUB 630
330 HOME
340 FOR I = 1 TO PC
350 PRINT "STYPKA: ";I;": ";M$(I);" ";D(I)
360 NEXT I
370 PC = PC+1
380 GOTO 200
...
620 RETURN
630 A = PEEK(OL+P1): A = PEEK(OL+P2): A = PEEK(OL+3): PRINT OL+P1; OL+P2; OL+3
640 FOR J = 1 TO D(PC)
650 FOR L = 1 TO 600
660 NEXT L
670 A = PEEK(-16384): IF A = 243 THEN A = PEEK(49168): GOTO 740
680 NEXT J
690 A = PEEK(OL+2): PRINT(OL+2): REM STOP
700 RETURN
710 PRINT "NATISNETE RETURN ZA MENUTO"
720 INPUT Z$
730 RETURN
740 A = PEEK(OL+2): PRINT(OL+2): REM STOP
750 END 
